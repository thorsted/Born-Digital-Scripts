...
if __name__ == "__main__":
    ...
    if finder_info:
        ...
        print("Type Code:", type_code.decode('macroman'))
        print("Creator Code:", creator_code.decode('macroman'))
...
df = pd.read_csv('TCDB_2003.8_data-cleaned.csv', encoding='utf-8')
# Search for rows containing the type code
rows_with_codes = df[(df['Type'] == type_code.decode('macroman')) & (df['Creator'] == creator_code.decode('macroman'))]
...
if not rows_with_codes.empty:
	...
	print("No rows found with Type Code {} and Creator Code {}.".format(type_code.decode('macroman'), creator_code.decode('macroman')))